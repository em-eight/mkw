...
def provide_ppc2cpp():
    if not os.path.exists(PPC2CPP):
        ...
        if sys.platform == "win32" or sys.platform == "msys":
            ppc2cpp_url = "https://github.com/em-eight/ppc2cpp/releases/download/v1.0-rc3/ppc2cpp-Windows.zip"
        else:
            ppc2cpp_url = "https://github.com/em-eight/ppc2cpp/releases/download/v1.0-rc3/ppc2cpp-Linux.zip"
